...
Part \ref{part:programming} discusses how you can program in NIMBLE, allowing you to use user-defined function or distributions in your BUGS code, compiling your R code for faster operations, and writing algorithms with NIMBLE, either specific algorithms for your particular model (such as a user-defined MCMC sampler for a parameter in your model) or general algorithms you can distribute to others.
The algorithm
