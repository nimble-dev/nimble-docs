...
% \cd{factorial(x)} & factorial & $x!$ [DISABLE!]   & \Checkmark & \Checkmark\\
 ...
 \cd{qDIST(x, PARAMS)} &``q''  distribution functions &  canonical parameterization & \Checkmark & \\
 \cd{pDIST(x, PARAMS)} &``p''  distribution functions &  canonical parameterization & \Checkmark & \\
