...
{\color{red} This didn't seem to fit in Using Models chapter because
  of all the discussion and examples with nimbleFunctions, though some
  of this functionality can be used from R. Thoughts welcome.}
