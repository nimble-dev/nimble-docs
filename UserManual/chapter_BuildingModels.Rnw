...
you need to explicitly register your distribution as described below.  
...
\paragraph{Using \cd{registerDistributions} for alternative
...
can't obtain directly from the \cd{nimbleFunctions} you write. 
