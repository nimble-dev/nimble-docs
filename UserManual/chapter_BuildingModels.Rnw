...
{\color{red} I think it's fine to pass as inits; same question arises earlier and in chapter 5}
...
## small bug in version 0.6-4 means we need to set 'data' to an
## empty list for this to work
